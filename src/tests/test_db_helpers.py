...
class TestQueryCache:
    ...
    def test_cache_miss_expired_data(self, query_cache, sample_filters):
        ...
        with patch.object(query_cache, 'read_table_from_databricks_sql', return_value=fresh_data):
            result = query_cache.get(sample_filters)
...
class TestIntegration:
    ...
    def test_full_cache_workflow(self, mock_db_config):
        ...
        with patch.object(cache, 'read_table_from_databricks_sql', return_value=test_data):
